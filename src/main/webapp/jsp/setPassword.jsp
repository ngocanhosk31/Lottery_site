    ...
    <div id="wrapper">
        <div class="container">
            <div class="row justify-content-center">
                <form action="${pageContext.request.contextPath}/SignUp" class="col-md-6 p-3 my-3" method="POST">
                    <h2 class="text-center text-uppercase py-2">Xổ số kiến thiết</h2>
                    <h3 class="text-center py-2">Mật khẩu đã được gửi đến email của bạn. Mời bạn đặt lại mật khẩu</h3>
                    <h5 style="color:red">${errorSignup}</h5>
                    <h5 style="color:red">${error}</h5>
                    <h5 style="color:red" id='message'></h5>
                    <div class="form-group">
                                <input type="hidden" class="form-control" value="${hoTen }" name="hoTen" placeholder="Email" required>
                            </div>
                    <div class="form-group">
                        <input type="text" class="form-control" value="${email }" name="email" placeholder="Email" required>
                    </div>
                    <div class="form-group">
                        <div class="input-icons">
                            <input class="form-control my-3" id="password-field1" type="password" value="${password}" name="matKhau" placeholder="Mật khẩu" required>
                            <span toggle="#password-field1" class="fa fa-fw fa-eye field-icon  toggle-password pass"></span>
                        </div>
                        <div class="input-icons">
